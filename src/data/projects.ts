...
export const projects: Project[] = [
  {
    title: 'OSS Pulse',
    description: 'Research and data-engineering demonstration testing whether a company\'s public GitHub activity (commit velocity, contributor retention, release cadence) signals engineering health — most defensible for open-core companies where the repo is the product. A controlled replication of a 2026 SSRN paper that found no such correlation at big tech companies, using longer forward windows and honestly reported sample sizes. Large-scale ingestion from the GitHub API and yfinance, a from-scratch scoring methodology, a scheduled CI pipeline, and a full-stack dashboard. Not a trading system or investment advice.',
